      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white text-gray-900">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-4">
            <Button variant="secondary" fullWidth onClick={handleGoogleSignup} className="font-semibold text-gray-700">
              <GoogleIcon />
              {t.auth.signUpGoogle}
            </Button>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">{t.auth.orSignUpEmail}</span>
              </div>
            </div>
          </div>
